...
<div class="container" style="margin-top: 100px;">
    ...
    <form action="{{ isset($categoria) ? route('categorias.update', $categoria->id) : route('categoria.store') }}" method="POST" class="mx-auto" style="max-width: 600px;" enctype="multipart/form-data">
        @csrf
        @if (isset($categoria))
            @method('PUT')
        @endif
